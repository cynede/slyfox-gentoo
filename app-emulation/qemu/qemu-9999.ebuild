...
# The ebuild is based on gentoo-x86 version of 19 Aug 2013 which:
#   1. got obfuscated with incomplete build system for sys-fermware/*bios
#      http://bugs.gentoo.org/459346
#   2. and then deliberately broken to depend on them
#      http://bugs.gentoo.org/481594
...
DESCRIPTION="QEMU + Kernel-based Virtual Machine userland tools (vanilla upstream)"
